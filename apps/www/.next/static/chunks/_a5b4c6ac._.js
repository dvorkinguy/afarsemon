...
function BookingCalendar() {
    ...
    const openInNewTab = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f2e$pnpm$2f$next$40$15$2e$4$2e$6_$40$babel$2b$core$40$7$2e$28$2e$3_$40$opentelemetry$2b$api$40$1$2e$9$2e$0_$40$playwright$2b$test$40$1$2e$55$2e$0_react$2d$d_369d37965ae8cf0a48106bfbb0e6af64$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "BookingCalendar.useCallback[openInNewTab]": ()=>{
    ...
    const initializeCalOfficial = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f2e$pnpm$2f$next$40$15$2e$4$2e$6_$40$babel$2b$core$40$7$2e$28$2e$3_$40$opentelemetry$2b$api$40$1$2e$9$2e$0_$40$playwright$2b$test$40$1$2e$55$2e$0_react$2d$d_369d37965ae8cf0a48106bfbb0e6af64$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "BookingCalendar.useCallback[initializeCalOfficial]": ()=>{
            try {
                // Official Cal.com embed snippet pattern
                ({
                    "BookingCalendar.useCallback[initializeCalOfficial]": function(C, A, L) {
                        const p = {
                            "BookingCalendar.useCallback[initializeCalOfficial].p": function(a, ar) {
                                if (a.q) a.q.push(ar);
                            }
                        }["BookingCalendar.useCallback[initializeCalOfficial].p"];
                        const d = C.document;
                        C.Cal = C.Cal || ({
                            "BookingCalendar.useCallback[initializeCalOfficial]": function() {
                                ...
                                if (ar[0] === L) {
                                    const api = {
                                        "BookingCalendar.useCallback[initializeCalOfficial].api": function() {
                                            for(var _len = arguments.length, apiArgs = new Array(_len), _key = 0; _key < _len; _key++){
                                                apiArgs[_key] = arguments[_key];
                                            }
                                            p(api, apiArgs);
                                        }
                                    }["BookingCalendar.useCallback[initializeCalOfficial].api"];
                ...
                })["BookingCalendar.useCallback[initializeCalOfficial]"](window, "https://cal.com/embed.js", "init");
                // Initialize Cal.com
                if (window.Cal) {
                    window.Cal("init", {
                ...
                if (window.Cal) {
                    window.Cal("on", {
                        action: "linkReady",
                        callback: {
                            "BookingCalendar.useCallback[initializeCalOfficial]": (e)=>{
    ...
    const retryLoad = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f2e$pnpm$2f$next$40$15$2e$4$2e$6_$40$babel$2b$core$40$7$2e$28$2e$3_$40$opentelemetry$2b$api$40$1$2e$9$2e$0_$40$playwright$2b$test$40$1$2e$55$2e$0_react$2d$d_369d37965ae8cf0a48106bfbb0e6af64$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "BookingCalendar.useCallback[retryLoad]": ()=>{
            ...
            setRetryCount({
                "BookingCalendar.useCallback[retryLoad]": (prev)=>prev + 1
            }["BookingCalendar.useCallback[retryLoad]"]);
            ...
            }["BookingCalendar.useCallback[retryLoad]"], 1000);
        }
    }["BookingCalendar.useCallback[retryLoad]"], [
        initializeCalOfficial,
        retryCount
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f2e$pnpm$2f$next$40$15$2e$4$2e$6_$40$babel$2b$core$40$7$2e$28$2e$3_$40$opentelemetry$2b$api$40$1$2e$9$2e$0_$40$playwright$2b$test$40$1$2e$55$2e$0_react$2d$d_369d37965ae8cf0a48106bfbb0e6af64$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "BookingCalendar.useEffect": ()=>{
            ...
            const timeout = setTimeout({
                "BookingCalendar.useEffect.timeout": ()=>{
                    if (loadingState === 'loading') {
                        setLoadingState('timeout');
                    }
                }
            }["BookingCalendar.useEffect.timeout"], 10000);
            initializeCalOfficial();
            return ({
                "BookingCalendar.useEffect": ()=>{
                                ...
                                children: [
                                    ...
                                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f2e$pnpm$2f$next$40$15$2e$4$2e$6_$40$babel$2b$core$40$7$2e$28$2e$3_$40$opentelemetry$2b$api$40$1$2e$9$2e$0_$40$playwright$2b$test$40$1$2e$55$2e$0_react$2d$d_369d37965ae8cf0a48106bfbb0e6af64$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$www$2f$src$2f$components$2f$ui$2f$alert$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["AlertDescription"], {
                                        children: [
                                            ...
                                            retryCount > 0 && " (ניסיון ".concat(retryCount + 1, ")")
                                        ]
                                    }, void 0, true, {
                                        fileName: "[project]/apps/www/src/components/booking-calendar.tsx",
                                        lineNumber: 249,
...
_s(BookingCalendar, "Or8j5vwL89SJDTGKYoDiOW1ulyE=");
_c = BookingCalendar;
var _c;
...
"[project]/node_modules/.pnpm/lucide-react@0.539.0_react@19.1.0/node_modules/lucide-react/dist/esm/icons/rotate-ccw.js [app-client] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
const RotateCcw = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f2e$pnpm$2f$lucide$2d$react$40$0$2e$539$2e$0_react$40$19$2e$1$2e$0$2f$node_modules$2f$lucide$2d$react$2f$dist$2f$esm$2f$createLucideIcon$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"])("rotate-ccw", __iconNode);
;
 //# sourceMappingURL=rotate-ccw.js.map
}),
"[project]/node_modules/.pnpm/lucide-react@0.539.0_react@19.1.0/node_modules/lucide-react/dist/esm/icons/rotate-ccw.js [app-client] (ecmascript) <export default as RotateCcw>": ((__turbopack_context__) => {
"use strict";

__turbopack_context__.s({
    "RotateCcw": ()=>__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f2e$pnpm$2f$lucide$2d$react$40$0$2e$539$2e$0_react$40$19$2e$1$2e$0$2f$node_modules$2f$lucide$2d$react$2f$dist$2f$esm$2f$icons$2f$rotate$2d$ccw$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"]
});
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f2e$pnpm$2f$lucide$2d$react$40$0$2e$539$2e$0_react$40$19$2e$1$2e$0$2f$node_modules$2f$lucide$2d$react$2f$dist$2f$esm$2f$icons$2f$rotate$2d$ccw$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/.pnpm/lucide-react@0.539.0_react@19.1.0/node_modules/lucide-react/dist/esm/icons/rotate-ccw.js [app-client] (ecmascript)");
}),
}]);

//# sourceMappingURL=_a5b4c6ac._.js.map