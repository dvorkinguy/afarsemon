...
"[project]/apps/www/.next-internal/server/app/api/diagnostics/route/actions.js [app-rsc] (server actions loader, ecmascript)": ((__turbopack_context__) => {
...
"[project]/apps/www/src/app/api/diagnostics/route.ts [app-route] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
async function GET(request) {
    ...
    try {
        ...
        const env = {
            ...
            NEXT_PUBLIC_APP_URL: Boolean(("TURBOPACK compile-time value", "http://localhost:3000")),
        ...
        if (env.POSTGRES_URL) {
            try {
                const [{ db }, { sql }, schema] = await Promise.all([
                    __turbopack_context__.r("[project]/apps/www/src/lib/db.ts [app-route] (ecmascript, async loader)")(__turbopack_context__.i),
                    __turbopack_context__.r("[project]/node_modules/.pnpm/drizzle-orm@0.44.4_@opentelemetry+api@1.9.0_@types+pg@8.15.5_@upstash+redis@1.35.3_kyse_fe72ec2fedcac09bf00de1e2989f8f6f/node_modules/drizzle-orm/index.js [app-route] (ecmascript, async loader)")(__turbopack_context__.i),
                    __turbopack_context__.r("[project]/apps/www/src/lib/schema.ts [app-route] (ecmascript, async loader)")(__turbopack_context__.i)
                ]);
                // Ping DB
        ...
        return (0, __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$www$2f$src$2f$lib$2f$security$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["createSecureResponse"])(response);
    } catch (error) {
        ...
        return (0, __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$www$2f$src$2f$lib$2f$security$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["createErrorResponse"])('Diagnostics information unavailable', 500, error);
    }
}
}),
...
//# sourceMappingURL=%5Broot-of-the-server%5D__df072e14._.js.map