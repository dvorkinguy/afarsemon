...
"[project]/apps/www/.next-internal/server/app/api/auth/debug/route/actions.js [app-rsc] (server actions loader, ecmascript)": ((__turbopack_context__) => {
...
"[project]/apps/www/src/app/api/auth/debug/route.ts [app-route] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
async function GET(request) {
    ...
    const validation = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$www$2f$src$2f$lib$2f$security$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["validateRequest"])(request, {
        requireAdmin: ("TURBOPACK compile-time value", "development") === 'production',
        rateLimitType: 'debug',
        allowedMethods: [
            'GET'
        ]
    ...
    try {
        ...
        const envCheck = {
            // Public URLs
            NEXT_PUBLIC_APP_URL: ("TURBOPACK compile-time value", "http://localhost:3000") || 'NOT_SET',
            NEXT_PUBLIC_BETTER_AUTH_URL: ("TURBOPACK compile-time value", "http://localhost:3000") || 'NOT_SET',
        ...
        const effectiveBaseUrl = process.env.BETTER_AUTH_URL || ("TURBOPACK compile-time value", "http://localhost:3000") || 'http://localhost:3000';
        ...
        try {
            ...
            await __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$www$2f$src$2f$lib$2f$db$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["postgresClient"]`SELECT 1 as test`;
            ...
            if ("TURBOPACK compile-time truthy", 1) {
                ...
                for (const table of tables){
                    try {
                        const countResult = await __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$www$2f$src$2f$lib$2f$db$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["postgresClient"]`SELECT COUNT(*) as count FROM ${(0, __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$www$2f$src$2f$lib$2f$db$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["postgresClient"])(table)}`;
        ...
        const authHandlerStatus = {
            available: false,
            error: null
        };
        try {
            if (__TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$www$2f$src$2f$lib$2f$auth$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["auth"] && __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$www$2f$src$2f$lib$2f$auth$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["auth"].handler) {
                authHandlerStatus.available = true;
                // Only show handler methods in development
                if ("TURBOPACK compile-time truthy", 1) {
                    const handlerMethods = __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$www$2f$src$2f$lib$2f$auth$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["auth"].handler ? Object.keys(__TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$www$2f$src$2f$lib$2f$auth$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["auth"].handler) : [];
        ...
        return (0, __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$www$2f$src$2f$lib$2f$security$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["createSecureResponse"])(debugInfo);
    } catch (error) {
        console.error('[Debug] Debug endpoint error:', error);
        return (0, __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$www$2f$src$2f$lib$2f$security$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["createErrorResponse"])('Debug information unavailable', 500, error);
    }
}
...
//# sourceMappingURL=%5Broot-of-the-server%5D__b57645e3._.js.map